...
import { AiOutlineComment, AiOutlineShareAlt, AiOutlineEllipsis } from "react-icons/ai";
import './home.css'
import './search.css'
...
const Search = () => {
  ...
  const displayedPosts = postes.filter((post) =>
    post.uname.toLowerCase().includes(searchTerm.toLowerCase())
  ).slice(0, 5);
